...
SECRET_KEY = 'django-insecure-9ls70%7^*91n964^7)7*__n-ju+ppybkp4ox5lhtu_l=z3!+3('
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Add WhiteNoise here (right after SecurityMiddleware)
